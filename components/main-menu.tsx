...
export default function MainMenu({ onPlay, onMultiplayer, onSettings, soundEnabled, toggleSound }: MainMenuProps) {
  ...
  const isWalletConnected = isConnected && address && chainId === etherlink.id
          ...
          >
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-yellow-200">Blockchain Integration</h3>
                  <p className="text-gray-300">Etherlink L2 Network</p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-yellow-200">Smart Contracts</h3>
                  <p className="text-gray-300">Battle Arena Protocol</p>
                </div>
                <div>
